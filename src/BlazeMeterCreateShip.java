 ...
 */
@ActionDescriptor(
        name = "BlazeMeter - Create Ship",
        description = "List all BlazeMeter harbors (Private Locations) for an account and workspace.",
        category="BlazeMeter." )
    public class BlazeMeterCreateShip extends Action {
    private static final long serialVersionUID = 1L;
    private static final Logger log = Logger.getLogger(BlazeMeterCreateShip.class);
    ...
    public void setshipname2(String shipname2) {
        this.shipname2 = shipname2;
                ...
                public String getharborid3() {
        return harborid3;
    } 
    
    public void setharborid3(String harborid3) {
        this.harborid3 = harborid3;
    }
        // Getters and Setters
    ...
    public void setexitcode3(Integer exitcode3) {
        this.exitcode3 = exitcode3;
            ...
            public String getshipid4() {
        return shipid4;
    }
    
    public void setshipid4(String shipid4) {
        this.shipid4 = shipid4;
    }
    ...
    public ActionResult execute() {
        ...
        try {
            log.debug("A call was received to execute a Restful Action: " + "BlazeMeter - Create Ship");

            String rawRequestValue = "{ \"name\": \"${Ship Name}\"}";

            response = new RestClientManager().restCall(HttpMethod.POST, authType, getInput(),
                "https://a.blazemeter.com:443/api/v4/harbors/${harbor Id}/ships", 60, "", "",
            ...
            response = new HttpRDKResponse("There was an error trying to execute a REST Call Action: '"
                + "BlazeMeter - Create Ship" + "' for Action Pack: "   + "", null, -1);
            ...
            log.debug("Output is empty");
              ...
              exitcode3 = Integer.valueOf(stringMatch);
                ...
                log.error("Caught exception during populating output parameter: " + "Exit Code", e);
                    ...
                    try {
                                                            Object objectMatch = JsonPath.read(output.getContent(), "$..id");
                                                    
                if (objectMatch != null) {
                                            String stringMatch = objectMatch.toString();
                                                                                            shipid4 = String.valueOf(stringMatch);
                                                            }
    ...
    private List<InputParam> getInput() {
            ...
            inputParameters.add(p);     
                    p = new InputParam();
            p.setName("Ship Name");
                                    p.setVariableName("shipname");
            p.setPrefix("");
            p.setType(VarType.String);
                                                                     p.setValue(shipname2);
    ...
    private List<OutputParam> getOutput() {
            ...
            outputParameters.add(p);                    
                    p = new OutputParam();
            p.setName("Ship Id");
                                    p.setVariableName("shipid");
            p.setType(VarType.String);
            
                            p.setFilterType(FilterType.JSON);
                        
                                                                     p.setFilterValue( shipid4 );
