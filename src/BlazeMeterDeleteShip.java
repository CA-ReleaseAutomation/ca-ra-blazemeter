 ...
 */
@ActionDescriptor(
        name = "BlazeMeter - Delete Ship",
        description = "List all BlazeMeter harbors (Private Locations) for an account and workspace.",
        category="BlazeMeter." )
    public class BlazeMeterDeleteShip extends Action {
    private static final long serialVersionUID = 1L;
    private static final Logger log = Logger.getLogger(BlazeMeterDeleteShip.class);
    ...
    @ParameterDescriptor(
        ...
        @ParameterDescriptor(
        name = "Ship ID",
        description = "Ship ID Description",
        out = false,
        in = true,
        nullable = true, // parameter not required
        order = 30,
    ...
    public void setharborid2(String harborid2) {
        this.harborid2 = harborid2;
                ...
                public String getshipid3() {
        return shipid3;
    } 
    
    public void setshipid3(String shipid3) {
        this.shipid3 = shipid3;
    }
        // Getters and Setters
    ...
    public ActionResult execute() {
        ...
        try {
            log.debug("A call was received to execute a Restful Action: " + "BlazeMeter - Delete Ship");

            String rawRequestValue = "{ \"name\": \"${Ship Name}\"}";

            response = new RestClientManager().restCall(HttpMethod.DELETE, authType, getInput(),
                "https://a.blazemeter.com:443/api/v4/harbors/${harbor Id}/ships/${Ship ID}", 60, "", "",
            ...
            response = new HttpRDKResponse("There was an error trying to execute a REST Call Action: '"
                + "BlazeMeter - Delete Ship" + "' for Action Pack: "   + "", null, -1);
